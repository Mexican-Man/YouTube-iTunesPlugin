...
t&&(this.adamId=t.getAttribute("adam-id"))}function ITSPlayVideoController(e){this.init(e)}function dbg(e){}function info(e){}function checkIfAskPermissionApprovalSheet(){if(-1<navigator.userAgent.indexOf("AskPermission")){var e=document.getElementsByTagName("html")[0];
...
if((its.url.originalLocationQueryParams.mt==="8"||window.location.href.indexOf("/app/")>=0)&&(navigator.userAgent.indexOf("Macintosh")>=0||navigator.userAgent.indexOf("Windows")>=0)){t=!1;
...
var n=its.detect.currentPageIsMacAppStore()||its.url.queryParamValue("mt",t)=="12"||t.indexOf("associateVPPUserWithITSAccount")!==-1||t.indexOf("vpp-associate")!==-1,r=its.detect.currentPageIsMacBookStore(t),i=!1,s,o=navigator.userAgent,u=o.match("Android");
n?(i=its.detect.macAppStoreDetected(),s="macappstore"):r&&its.detect.macBookStoreDetected()?(i=!0,s="itms-books"):/payPalMIPReturn/.test(t)?(i=!0,s="itms"):/linkAccountPage/.test(t)?(i=!0,s="itms"):(i=its.detect.itunesDetected(),s="itms",!i&&/CPU iPhone/.test(o)&&(i=!0,/app=music/.test(t)&&(s="music")));
if(i){t=t.replace(/^http/,s);
var a=t.indexOf("#");
a>-1&&(t=t.substring(0,a));
if(t.indexOf("payPalMIPReturn")===-1&&t.indexOf("firstGateReturn")===-1&&t.indexOf("payclickSignUpReturn")===-1&&t.indexOf("payclickBillingReturn")===-1){var f=t.indexOf("?")===-1?"?":"&";
(new RegExp("itunes[.]apple[.]com/(../station/|WebObjects/MZStore.woa/wa/viewRadioStation[?])")).test(t)&&(t+=f+"cmd=AddStation",f="&"),(new RegExp("itunes[.]apple[.]com/(../radio|WebObjects/MZStore.woa/wa/viewRadioMain)([?/]|$)")).test(t)&&(t+=f+"cmd=ViewStations",f="&");
var l=its.cookies.get("a");
l&&(t+=f+"affC="+its.detect.encodedQueryParameter(l),f="&");
var c=its.cookies.getUnescaped("itcCt");
c&&(t+=f+"itcCt="+its.detect.encodedQueryParameter(c),f="&");
var h=its.cookies.getUnescaped("itscc");
h&&(t+=f+"itscc="+h,f="&");
var p=its.cookies.getUnescaped("cmd");
p&&(t+=f+"cmd="+its.detect.encodedQueryParameter(p),f="&");
if(document.referrer){var d=its.detect.encodedQueryParameter(document.referrer);
t.length+d.length<400&&(dbg("openItunes: Attaching "+document.referrer),t+=f+"ign-msr="+d)}}}else if(!its.detect.itunesDetected()||t.indexOf("associateVPPUserWithITSAccount")===-1&&t.indexOf("vpp-associate")===-1){if(u){t=window.location.href.replace(/^http/,"apple-music");
...
E.setAttribute("class","link-arrow"),y.appendChild(b),y.appendChild(w),y.appendChild(E),g.appendChild(y),m.appendChild(g);
var S=document.getElementsByClassName("title")[0];
S.innerHTML="",S.appendChild(v),S.parentNode.insertBefore(m,S.nextSibling);
var x=document.getElementsByClassName("footer")[0];
return x.innerHTML="",!1}var f=t.indexOf("?")===-1?"?":"&";
(new RegExp("itunes[.]apple[.]com/(../station/|WebObjects/MZStore.woa/wa/viewRadioStation[?])")).test(t)&&(t+=f+"cmd=AddStation",f="&"),t=t.replace(/^http/,"itms")}else t=t.replace(/^http/,"itms");
